...
func _ready() -> void:
	...
	align_picker.update_items(PersonProfile.ALIGN_LIST.keys())
...
func reconnect_ui_by_selected_person() -> void:
	...
	if is_instance_valid(personinfo):
		...
		align_picker.select_item_by_index(PersonProfile.ALIGN_LIST.CENTER)
...
func _update_ui() -> void:
	...
	if blockinfo is NBI_Mood:
		if is_block_fresh():
			...
			blockinfo.align = PersonProfile.ALIGN_LIST.CENTER
