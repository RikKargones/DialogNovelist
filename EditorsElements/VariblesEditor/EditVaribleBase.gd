...
func on_delete_bt_press() -> void:
	var connect_info = Ui.ConnectInfo.new(self, "delete_confirmed")
	Ui.popup_confirm(connect_info, "Are you sure to delete this varible/signal?")
...
func on_rename_bt_press() -> void:
	...
	var connect_info = Ui.ConnectInfo.new(self, "rename_confirmed")
	Ui.popup_namer(connect_info, title, VariblesData.get_varibles_and_signals_list(), "", true)
